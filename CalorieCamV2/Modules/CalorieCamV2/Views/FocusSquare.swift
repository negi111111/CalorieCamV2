...
class FocusSquare: SCNNode {
    ...
    private let focusSquareColor = #colorLiteral(red: 0, green: 0.9914394021, blue: 1, alpha: 1)
    private let focusSquareColorLight = #colorLiteral(red: 0.6039275085, green: 0.9801963754, blue: 1, alpha: 1) 
